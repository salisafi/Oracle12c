$(document).ready(function(){$('.cheat_sheet_row').matchHeight(true);$('nav li ul').hide().removeClass('fallback');$('nav>ul>li>ul').each(function(){var offset=($(this).parent().position())*-1;var left=($(this).parent().width()/ 2)-170;if(left>offset.left){left=offset.left;}
...
$('#ratingStarsCount').show();$('#ratingStarsCount a').html(ratingCount);});});if(deviceBracket=='desktop'){$('.footer_popup_inner').append('<a href="#" class="imagelink footer_popup_close"><i class="fa fa-close"></i></a>');$('.footer_popup_close').click(function(){$('.footer_popup').slideUp();return false;});setTimeout(function(){$('.footer_popup').slideDown();},5000);var menuPadding=$('#cs_menu .download_menu').height();if(menuPadding>0){$('#pagetitle h1').css('paddingTop',menuPadding+20);}}});function processTags(){var to_show='';var to_show_lang='';var to_show_rating='';var taglist='';var langlist='';var ratinglist='';var tagFilterFound=false;var langFilterFound=false;var ratingFilterFound=false;var filterFound=false;var selectedFavouriteTags=[];var selectedLanguages=[];var selectedRatings=[];var activeTagCount=0;$('input.tagoptions:checked').each(function(){activeTagCount=activeTagCount+1;filterFound=true;tagFilterFound=true;if(to_show.length>0){to_show=to_show+',';taglist=taglist+', ';}
